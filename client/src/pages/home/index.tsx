      ...
      <header className="fixed top-0 w-full z-50 border-b border-white/[0.05] bg-[#000000]/80 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-10 text-xs font-medium uppercase tracking-widest text-white/50">
            ...
            <a
              href="/mvp-academy"
              className="inline-flex items-center gap-2 px-3 py-1.5 border border-[#00ff88]/30 bg-[#00ff88]/5 rounded-full text-[#00ff88] hover:bg-[#00ff88]/10 hover:border-[#00ff88]/60 transition-all duration-300"
            >
              ...
              <SheetContent side="right" className="bg-black border-white/10 text-white">
                ...
                <div className="flex flex-col gap-2 px-4 pb-6">
                  ...
                  <SheetClose asChild>
                    <a
                      href="/mvp-academy"
                      className="inline-flex items-center gap-3 rounded-xl border border-[#00ff88]/30 bg-[#00ff88]/5 px-4 py-3 text-sm font-bold text-[#00ff88]"
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-[#00ff88] animate-pulse" />
                      MVP Academy
                    </a>
                ...
                <div className="mt-auto px-4 pb-6">
                  <SheetClose asChild>
                    <a
                      href="https://forms.gle/Kd1YSC9oceo9cuzt9"
      ...
      >
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            ...
            <a
              href="/mvp-academy"
              className="group inline-flex items-center gap-3 px-6 py-3 border border-[#00ff88]/30 bg-[#00ff88]/5 rounded-full text-[#00ff88] text-xs font-bold uppercase tracking-widest hover:bg-[#00ff88]/10 hover:border-[#00ff88]/60 transition-all duration-300"
            >
              <span className="w-1.5 h-1.5 rounded-full bg-[#00ff88] animate-pulse" />
              MVP Academy — Aprenda a implementar com IA
