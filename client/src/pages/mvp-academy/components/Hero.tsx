  ...
  return (
    <header className="relative pt-32 pb-24 md:pt-48 md:pb-40 px-6 overflow-hidden bg-black">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        >
          A diferença entre quem estuda e quem <span className="text-primary">fatura com IA</span> é a Implementação Assistida.
        </motion.h1>
        ...
        >
          Pare de colecionar vídeos. Em 4 semanas, com apenas 30 minutos/dia e nossa ajuda ao vivo, o seu primeiro projeto de IA estará no ar, pronto para vender.
        </motion.p>
        ...
        >
          ...
          >
            Garantir minha vaga no próximo Cohort — R$250/ano
          ...
          <div className="flex items-center gap-4 text-white/20 font-mono text-[10px] uppercase tracking-widest">
            ...
            <span className="flex items-center gap-1.5">Boilerplates_Prontos</span>
            <span className="w-1 h-1 rounded-full bg-white/10" />
            <span className="flex items-center gap-1.5">Garantia_Incondicional</span>
          </div>
        </motion.div>
      </div>
    </header>
