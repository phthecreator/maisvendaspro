          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {cases.map((item, i) => (
              <div key={i} className="border border-white/10 bg-[#050a1f] p-6 flex flex-col">
                <div className="mb-5 rounded-lg bg-white/[0.04] border border-white/10 aspect-video flex items-center justify-center text-white/30 text-xs uppercase tracking-widest">
                  {i === 0 ? 'Antes / Depois' : i === 1 ? 'Print do Bot' : 'Avatar Profissional'}
                </div>
