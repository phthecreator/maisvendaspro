# KB Chunk 004: Outcomes Over Output

**Source:** Cagan - Outcomes Philosophy
**Category:** Measurement & Metrics
**Tags:** #outcomes #metrics #measurement
...
- **Counter-metric:** Prevent gaming (e.g., trial quality, not just quantity)

## Core Principle

**Outcomes are simple conceptually but hard in practice** - requires systemic product model adoption, not OKR overlay on feature factory.

---

**Provenance:** Cagan source 05-outcomes-over-output.md
